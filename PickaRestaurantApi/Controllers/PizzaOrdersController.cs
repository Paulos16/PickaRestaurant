...
namespace PickaRestaurantApi.Controllers
{
    ...
    public class PizzaOrdersController : ControllerBase
    {
        ...
        public PizzaOrdersController(s16996Context context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<PizzaOrder>> PostPizzaOrder(PizzaOrder pizzaOrder)
        {
            ...
            {
                if (PizzaOrderExists(pizzaOrder.PizzaIdPizza))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetPizzaOrder", new { id = pizzaOrder.PizzaIdPizza }, pizzaOrder);
        }
        ...
        {
            return _context.PizzaOrder.Any(e => e.PizzaIdPizza == id);
        }
    }
}
